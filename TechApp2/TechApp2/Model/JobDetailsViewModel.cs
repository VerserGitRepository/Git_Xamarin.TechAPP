   ...
   public class JobDetailsViewModel
    {
        ...
        public List<JobAssetPhotes> JobAssetPhots { get; set; }
        public JobDetailsViewModel()
        {
            AssetsList = new List<AssetViewModel>();
            JobDocuments = new List<JobDocumentViewModel>();
            JobAssetPhots = new List<JobAssetPhotes>();
            RiskAssessment = new RiskAssessmentViewModel();
        }

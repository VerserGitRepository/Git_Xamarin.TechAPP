...
namespace TechApp2.Views.JobDetailed
{
    ...
    public partial class JobDetailedJobRiskAssess : ContentPage
    {
        ...
        private  void BtnupdateRiskAssess_Clicked(object sender, EventArgs e)
        {
            ...
            risksampleData.Add(new RiskAssessmentDto { RiskArea = "Other", Rating = OtherRisk.SelectedItem == null ? "N/A" : OtherRisk.SelectedItem.ToString(), RiskAssessment_Job = int.Parse(JobService.jobDetailsModel.JobNo), CreatedBy = "TestUser", Created = DateTime.Now });
